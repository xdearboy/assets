...
#for more tools check https://bytexdestroyers.netlify.app in case website wasnt working check https://t.me/ncsecurity
#thanks for using our tools ☺♥☻
# make sure to install all requirements needed or tool wont work!!!!
import requests
import colorama
import os
import threading
...
os.system(f'cls & mode 83,24 & title Discord Mass Reporter - Made By ByteX')

print(f"""{s+Fore.YELLOW}   ____    _                                   _     __  __                       
  ...
  |____/  |_| |___/  \___|  \___/  |_|     \__,_|   |_|  |_|  \__,_| |___/ |___/ {Fore.RESET} {s+Fore.WHITE}
             ...
             |_| \_\  \___| | .__/   \___/  |_|     \__|  \___| |_|   
                         ...
                         {s+Fore.RED} made with ♥ by Gabriel                                           

                            {Fore.RESET}

{s+Fore.MAGENTA} 0 > {Fore.RESET}Reasons:
{s+Fore.BLACK} 1 > {Fore.RESET}Illegal Content
{s+Fore.YELLOW} 2 > {Fore.RESET}Harrassment
{s+Fore.RED} 3 > {Fore.RESET}Spam Or Phishing Links
{s+Fore.GREEN} 4 > {Fore.RESET}Self Harm
{s+Fore.CYAN} 5 > {Fore.RESET}NSFW Content
""")
